package hu.frontrider.gearcraft.core.gui

import hu.frontrider.gearcraft.GearCraft
import hu.frontrider.gearcraft.core.gui.widgets.interfaces.Clickable
import hu.frontrider.gearcraft.core.gui.widgets.interfaces.DebugDraw
...
open class BaseGui : GuiScreen() {
    companion object {
        val BACKGROUND = ResourceLocation(GearCraft.MODID, "textures/gui/guide/base.png")
        val TAB = ResourceLocation(GearCraft.MODID, "textures/gui/guide/tab.png")
        var xSize = 176
        var ySize = 166
        var debug = true
    }
