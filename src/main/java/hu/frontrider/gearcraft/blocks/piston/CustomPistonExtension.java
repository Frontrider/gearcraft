...
public class CustomPistonExtension extends BlockDirectional {
    public static final PropertyEnum<net.minecraft.block.BlockPistonExtension.EnumPistonType> TYPE = PropertyEnum.create("type", net.minecraft.block.BlockPistonExtension.EnumPistonType.class);
    ...
    private MechanicalPistonBase base;

    public CustomPistonExtension(MechanicalPistonBase base) {

        super(Material.PISTON);
        this.base = base;
        this.setDefaultState(this.blockState.getBaseState().withProperty(FACING, EnumFacing.NORTH).withProperty(TYPE, net.minecraft.block.BlockPistonExtension.EnumPistonType.DEFAULT).withProperty(SHORT, Boolean.valueOf(false)));
        this.setSoundType(SoundType.STONE);
        this.setHardness(0.5F);
        setRegistryName(MODID, "gearcraft_piston_extension");
    }
    ...
    public void breakBlock(World worldIn, BlockPos pos, IBlockState state) {
        ...
        if ((iblockstate.getBlock() instanceof MechanicalPistonBase) && iblockstate.getValue(BlockPistonBase.EXTENDED).booleanValue()) {
    ...
    public void neighborChanged(IBlockState state, World worldIn, BlockPos pos, Block blockIn, BlockPos fromPos) {
        ...
        if (!(iblockstate.getBlock() instanceof MechanicalPistonBase)) {
            worldIn.setBlockToAir(pos);
        } else {
    ...
    public ItemStack getItem(World worldIn, BlockPos pos, IBlockState state) {
        return new ItemStack(state.getValue(TYPE) == net.minecraft.block.BlockPistonExtension.EnumPistonType.STICKY ? Blocks.STICKY_PISTON : Blocks.PISTON);
    }
    ...
    public IBlockState getStateFromMeta(int meta) {
        return this.getDefaultState().withProperty(FACING, getFacing(meta)).withProperty(TYPE, (meta & 8) > 0 ? net.minecraft.block.BlockPistonExtension.EnumPistonType.STICKY : net.minecraft.block.BlockPistonExtension.EnumPistonType.DEFAULT);
    }
