...
public class MechanicalPistonBase extends BlockDirectional implements TooltippedBlock
{
    ...
    public MechanicalPistonBase(boolean isSticky)
    {
        ...
        setRegistryName(GearCraft.MODID,"mechanical_piston");
    }
    ...
    private void checkForMove(World worldIn, BlockPos pos, IBlockState state)
    {
        ...
        {
            if ((new CustomBlockPistonStructureHelper(worldIn, pos, enumfacing, true)).canMove())
            {
    ...
    private boolean doMove(World worldIn, BlockPos pos, EnumFacing direction, boolean extending)
    {
        ...
        CustomBlockPistonStructureHelper blockpistonstructurehelper = new CustomBlockPistonStructureHelper(worldIn, pos, direction, extending);
